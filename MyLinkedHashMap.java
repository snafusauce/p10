...
public class MyLinkedHashMap<K, V> implements MyMap<K, V> {
    ...
    public void clear() {
        ...
        // reset everything using a new hashtable
        sz = 0;
        cap = DEFAULT_SIZE;
        first = true;
    }
    ...
    public boolean containsKey(K key) {
        //unsure whats going on with this line
        ...
        for (int i = 0; i < cap; ++i) {
            ...
            while (curNode != null) {
                ...
                {
                    // only returns true if the ternary is true
                    return true;
                }
    ...
    public V get(K key) {
        ...
        while (curNode != null) {
            if (key == null ? curNode.key == null : key.equals(curNode.key)) {
                // ends the while loop since we found the val
                ret = curNode.val;
                break;
            }
            curNode = curNode.next;
    ...
    public V getOrDefault(K key, V defaultValue) {
        ...
        while (curNode != null) {
            if (key == null ? curNode.key == null : key.equals(curNode.key)) {
                // sets ret to val if there is one otherwise leaves it as default
